...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener {
    ...
    private void jbNotificationExtras(boolean lowpriority,
        ...
        try {
            ...
            nbuilder.addAction(R.drawable.ic_close_white_24dp,
            ...
            if (mDeviceStateReceiver == null || !mDeviceStateReceiver.isUserPaused()) {
                ...
                nbuilder.addAction(R.drawable.ic_pause_white_24dp,
                        getString(R.string.pauseVPN), pauseVPNPending);

            } else {
                pauseVPN.setAction(RESUME_VPN);
                PendingIntent resumeVPNPending = PendingIntent.getService(this, 0, pauseVPN, 0);
                nbuilder.addAction(R.drawable.ic_play_arrow_white_24dp,
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null && intent.hasExtra(getPackageName() + ".profileUUID")) {
            ...
            if (mProfile == null) {
                Log.e("Profile null", "Recreate profile");
                if (intent.hasExtra(getPackageName() + ".object"))
                    mProfile = (VpnProfile) intent.getSerializableExtra(getPackageName() + ".object");
            }
        } else {
    ...
    public void updateByteCount(long in, long out, long diffIn, long diffOut) {
        calcTraffic(this, in, out, diffIn, diffOut);
